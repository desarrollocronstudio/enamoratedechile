...
<span class="cerca mobile ">Se han encontrado<font color="#D83E3F">{{$tips->count()}}</font> resultados</span>
<span id="secciones" style="display: block; cursor: pointer;">En otras secciones </span>
