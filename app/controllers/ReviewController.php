...
class ReviewController extends BaseController {
	...
	public function save($id)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to(action('view-tip',$id).'#reviews-anchor')->with('review_posted',true);
		}
		...
		return Redirect::to(action('view-tip',$id).'#reviews-anchor')->withErrors($validator)->withInput();
	}
